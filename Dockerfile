...
USER root
RUN curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.40.6/install.sh | bash && source /root/.bashrc && nvm install --lts && npm install -g nrm && npm install -g pnpm && apt-get update && \
